...
const AddressForm = ({ title, button, onClose, initialData }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const endpoint = initialData ? `/address/add/${id}/${data._id}` : `/address/add/${id}`;
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className={`w-full p-2 border ${errors.name ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition`}
        />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className={`w-full p-2 border ${errors.streetAddress ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition`}
        />
        {errors.streetAddress && <p className="text-red-500 text-sm mt-2">*{errors.streetAddress.message}</p>}
      </div>
      ...
      <div className="flex space-x-4 mb-4">
        <div className="w-1/2">
          ...
          <input
            ...
            className={`w-full p-2 border ${errors.city ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition`}
          />
        ...
        <div className="w-1/2">
          ...
          <input
            ...
            className={`w-full p-2 border ${errors.state ? "border-red-500" : "border-gray-300"} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition`}
          />
      ...
      <div className="flex justify-end mt-4">
        <button type="submit" className="text-blue-500 hover:text-blue-700 hover:underline">
          {`${button} Address`}
        </button>
      </div>
    </form>
