...
//   // Retrieve the available offer from localStorage
//   const offerAvailable = JSON.parse(localStorage.getItem("savedOffer"));
//   console.log(offerAvailable);

//   const offerApply = async () => {
//     const { receiveObj } = await post("/apply-discount", {
//       offerId: offerAvailable.id,
//       totalPrice: cartData.totalPrice,
//     });
...
//       </div>
//       <div className="mt-10">
//         <button onClick={offerApply}>
//           {offerAvailable && (
//             <div className="bg-yellow-100 text-yellow-800 p-4 rounded-md mb-4">
//               <strong>Special Offer:</strong> {offerAvailable.option}
//             </div>
//           )}
//         </button>
//       </div>
